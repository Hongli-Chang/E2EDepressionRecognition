...
def readData(data_txt, SUB):
    ...
    with open(data_txt) as f:
        ...
        for l in lines:
            ...
            tempData = np.asarray(dataIn["EEGdata"], dtype=np.float32)
...
for n in range(53):
    ...
    print(SUB[n])
    dataDir = '/redhdd/changhongli/End2End_Depression_recognition/dataDir.txt'
    #pdb.set_trace()
   ...
   # model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy'])
    ...
    WEIGHTS_PATH = r'/redhdd/changhongli/End2End_Depression_recognition/arl-eegmodels-master/examples/%s.h5' % (SUB[n])
...
WEIGHTS_PATH1 = r'/redhdd/changhongli/End2End_Depression_recognition/arl-eegmodels-master/examples/'
...
txtName =  '/redhdd/changhongli/End2End_Depression_recognition/arl-eegmodels-master/examples/'
