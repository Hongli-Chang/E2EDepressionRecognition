...
def readData(data_txt, SUB):
    ...
    with open(data_txt) as f:
        ...
        for l in lines:
            ...
            tempData = np.asarray(dataIn["testF_X"], dtype=np.float32)
            tempLabel = np.asarray(dataIn["testF_Y"], dtype=np.float32)
...
for n in range(53):
    ...
    #
    print(SUB[n])
    dataDir = '/redhdd/changhongli/End2End_Depression_recognition/dataDirf.txt'
    #pdb.set_trace()
    ...
    # #
    WEIGHTS_PATH = r'/redhdd/changhongli/End2End_Depression_recognition/arl-eegmodels-master/fcue/%s.h5' % (SUB[n])
...
WEIGHTS_PATH1 = r'/redhdd/changhongli/End2End_Depression_recognition/arl-eegmodels-master/fcue/'
...
txtName =  '/redhdd/changhongli/End2End_Depression_recognition/arl-eegmodels-master/fcue/'
